...
The goal of regexcite.agendazhang is to make regular expressions more
...
You can install the development version of regexcite.agendazhang from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("agendazhang/regexcite.agendazhang")
```
...
That’s exactly what `regexcite.agendazhang::str_split_one()` does.

``` r
library(regexcite.agendazhang)
